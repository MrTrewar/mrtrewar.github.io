...
This project uses JavaScript, CSS, HTML, and Python. Frontend work involves vanilla JS with CSS styling. Use ES6+ syntax and modern CSS features.
...
- **Progression:** 3 levels unlocked at score thresholds (0 → JUNGLE, 1500 → CITY, 3000 → NIGHTPARK)
- **Difficulty Ramp:**
...
When creating plan files or any structured documents, use consistent naming: kebab-case for files, and verify file paths exist before referencing them in other files.

## Workflow

### Agent Usage

When spawning sub-agents, use sequential execution rather than parallel when tasks have dependencies. Always verify parameter formats before invoking agents.
